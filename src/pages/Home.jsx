    ...
    <>
      ...
      <section id="home" className="relative w-full min-h-screen overflow-hidden py-32 lg:py-0">
        ...
        <div className="relative z-10 flex flex-col justify-center h-full pt-8 lg:pt-36 px-6 sm:px-10 lg:px-16">
          ...
          <div className="fade-up-3 mt-8 lg:mt-10 flex flex-wrap items-center gap-4 sm:gap-6">
            <a
              href="https://demo-agent.aashirgujjar276.workers.dev/"
              target="_blank"
              rel="noreferrer"
              style={fontBody}
              className="group flex items-center gap-2 bg-[#0B2E5C] hover:bg-[#123B73] text-white px-5 sm:px-7 py-3 sm:py-4 text-[11px] sm:text-xs tracking-widest uppercase font-semibold transition-colors ember-focus"
            >
      ...
      <section className="relative px-6 sm:px-10 lg:px-16 py-24 lg:py-32 bg-white">
        <Reveal>
          ...
          <p style={fontBody} className="text-[#0B2E5C]/70 text-sm sm:text-base leading-relaxed max-w-lg mb-4">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-2 text-[#1E5FA8] hover:text-[#0B2E5C] text-sm font-semibold underline underline-offset-4 mb-10"
          >
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <Reveal>
            <form className="space-y-5" onSubmit={handleSubmit} style={fontBody}>
              ...
              {status && <p className="text-green-300 text-sm mt-3">{status}</p>}
            </form>
          </Reveal>
        </div>
      </section>
